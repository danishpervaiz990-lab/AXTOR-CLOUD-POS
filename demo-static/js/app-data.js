...
(function(){
  ...
  function initPWA(){ if('serviceWorker' in navigator && location.protocol.startsWith('http')) navigator.serviceWorker.register('sw.js?v=20260725-terminal-credit-v4').then(reg=>reg.update&&reg.update()).catch(()=>{}); }
  ensure();
