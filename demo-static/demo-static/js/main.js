(function(){
  const searchIndex = [
    ...
    ['Sales','Create and search invoices after setup','sales.html#new-sale','bi-receipt-cutoff'],
    ...
    ['Purchases','Create and pay supplier bills after setup','purchase.html#new-purchase','bi-bag-check'],
  ...
  function initPlatformRuntime(){ if(document.querySelector('script[data-axtor-platform]')) return; const script=document.createElement('script'); script.src='js/platform-runtime.js?v=20260725-stability'; script.defer=true; script.dataset.axtorPlatform='1'; document.body.appendChild(script); }
