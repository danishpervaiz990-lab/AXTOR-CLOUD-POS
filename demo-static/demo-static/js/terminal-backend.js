(function () {
  ...
  function totals() {
    ...
    // Credit is the amount left outstanding; it is not money received.  The
    // previous calculation counted it as paid, showing a zero balance and then
    // submitting a credit invoice without its required due date.
