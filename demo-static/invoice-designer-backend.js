...
(function(){
  ...
  function initPWA(){ if('serviceWorker' in navigator && location.protocol.startsWith('http')) navigator.serviceWorker.register('sw.js?v=20260726-railway-repair-r1').then(reg=>reg.update&&reg.update()).catch(()=>{}); }
  ensure();
