...
const permissionDefinitions = [
  ...
  ["sales_documents.override_customer_credit_hold", "Override customer credit hold for an invoice", "Controls"],
  ["customers.manage_credit_hold", "Hold or release customer credit accounts", "Customers"],
