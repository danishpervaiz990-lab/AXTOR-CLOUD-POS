...
export async function login(req: Request, res: Response): Promise<void> {
  try {
    ...
    const business = await prisma.business.findUnique({
      ...
      include: { businessIndustry: { include: { industry: { select: { code: true, name: true } } } } }
    });
    ...
    res.json({
      ...
      business: {
        ...
        industry: business.businessIndustry?.industry || null
      },
      user: {
        id: user.id,
        name: user.name,
...
export async function me(req: Request, res: Response): Promise<void> {
  try {
    ...
    const user = await prisma.user.findUnique({
      ...
      include: {
        business: { include: { businessIndustry: { include: { industry: { select: { code: true, name: true } } } } } },
        userRoles: {
          include: {
            role: true
          }
    ...
    res.json({
      ...
      business: {
        ...
        industry: user.business.businessIndustry?.industry || null
      },
      user: {
        id: user.id,
        name: user.name,
