...
import * as refundsRoutesModule from "./routes/refunds.routes.js";
import * as accessControlRoutesModule from "./routes/access-control.routes.js";
...
export function createApp() {
  ...
  const paymentsRoutes = getRouter(paymentsRoutesModule, [
    "default",
    "paymentsRoutes",
    "paymentsRouter",
    "router",
  ...
  const refundsRoutes = getRouter(refundsRoutesModule, ["default", "refundsRoutes", "refundsRouter", "router"]);

  const accessControlRoutes = getRouter(accessControlRoutesModule, ["default", "accessControlRoutes", "accessControlRouter", "router"]);
