  ...
  return {
    ...
    features: {
      ...
      scheduled_backups: {
        ...
        credentialsConfigured: backupProvider.credentialsConfigured,
        workerEnabled: backupProvider.workerEnabled,
        restoreConfigured: backupProvider.restoreConfigured,
      },
