...
console.log(`PASS: ${pages.length} Grocery pages with tenant-backed invoice output, shared invoice/return/refund routing, transactional receiving, FEFO and reports`);
